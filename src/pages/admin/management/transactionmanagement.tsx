...
import { useDeleteOrderMutation, useOrderDetailsQuery, useUpdteOrderMutation } from "../../../redux/api/orderApi";
...
const TransactionManagement = () => {
  ...
  const [upadetOrder] = useUpdteOrderMutation();
  const [deleteOrder] = useDeleteOrderMutation()

  

  const updateHandler = async()=> {
    const res = await upadetOrder({
      userId:user?._id!,
